...
UPDATE movies SET rank = ts_rank(lexemesStarring,plainto_tsquery( ( SELECT Starring FROM movies WHERE url='pirates-of-the-caribbean-the-curse-of-the-black-pearl' ) ));
...
\copy (SELECT * FROM recommendationsBasedOnStarringfield) to '/home/pi/RSL/top50recommendationsstarringpirates.csv'WITH csv;
