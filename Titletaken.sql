...
UPDATE movies SET rank = ts_rank(lexemestitle,plainto_tsquery( ( SELECT title FROM movies WHERE url='taken' ) ));
...
\copy (SELECT * FROM recommendationsBasedOntitlefield) to '/home/pi/RSL/top50recommendationtitletaken.csv'WITH csv;
