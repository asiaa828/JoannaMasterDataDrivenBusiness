...
UPDATE movies SET rank = ts_rank(lexemesSummary,plainto_tsquery( ( SELECT Summary FROM movies WHERE url='avengers' ) ));
...
\copy (SELECT * FROM recommendationsBasedOnSummaryfield) to '/home/pi/RSL/top50recommendationssummaryavengers.csv'WITH csv;
