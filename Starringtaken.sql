...
UPDATE movies SET rank = ts_rank(lexemesStarring,plainto_tsquery( ( SELECT Starring FROM movies WHERE url='taken' ) ));
...
\copy (SELECT * FROM recommendationsBasedOnStarringfield) to '/home/pi/RSL/top50recommendationsstarringtaken.csv'WITH csv;
